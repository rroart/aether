...
@PersistenceCapable(table="Files")
	...
	private Logger log = LoggerFactory.getLogger(DataNucleusFiles.class);
    ...
    public DataNucleusFiles ensureExistence(FileLocation fn) throws Exception {
    ...
    public DataNucleusFiles getByFilelocation(FileLocation filelocation) throws Exception {
	try {
    ...
    public List<DataNucleusFiles> getByMd5(String md5) throws Exception {
